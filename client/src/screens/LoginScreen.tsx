...
export function LoginScreen() {
  ...
  function refreshUsers() {
    window.electronAPI.listUsers('branch-316-001').then(setUsers)
  }
    ...
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center gap-8 p-8">
      ...
      <div className="text-center">
        <div className="w-16 h-16 rounded-2xl bg-dg flex items-center justify-center mx-auto mb-4">
          <span className="text-white font-semibold text-lg">316</span>
        </div>
        <h1 className="text-2xl font-medium text-dg">316 PCKLE</h1>
      ...
      <p className="text-xs text-gray-400">316 PCKLE POS v1.0 — Offline ready</p>
    </div>
  )
}
